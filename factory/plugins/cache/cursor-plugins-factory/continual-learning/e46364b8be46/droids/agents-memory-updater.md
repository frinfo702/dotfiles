...
3. Inspect only transcript files under `~/.factory/sessions/` that are new or have newer mtimes than the index.
...
- Updated `AGENTS.md` and `.factory/hooks/state/continual-learning-index.json` when needed

...
1. If the question is about **current config** (what MCP servers, models, or settings are active),
   read `/Users/ken702/.grok/config.toml`. MCP servers are under `[mcp_servers.*]` sections.
...
2. If the question is about **how to do something** (setup, adding MCP servers, creating skills,
   ...
   `/Users/ken702/.grok/docs/user-guide/`. The available guides are:
   ...
   `/Users/ken702/.grok/README.md` for the comprehensive reference.

3. To **modify config** for the user, edit `/Users/ken702/.grok/config.toml` with search_replace.

4. To **create a skill** for the user, create `/Users/ken702/.grok/skills/<name>/SKILL.md`
   (read `/Users/ken702/.grok/docs/user-guide/08-skills.md` for the SKILL.md format).
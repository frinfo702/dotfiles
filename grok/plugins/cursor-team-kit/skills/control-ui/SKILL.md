...
3. Prefer harnesses already available in the agent environment (Grok: Playwright / Chrome DevTools MCP tools when connected; repo-local Playwright otherwise).
4. For a web app, connect to the local URL with the existing browser tooling.

...
description: Create a fresh branch, complete work, and open a pull request. Use when starting new work that should ship through a clean branch and PR workflow.
---

...
description: Review the current branch for bugs, intent fit, and test coverage; run or write tests; commit focused work; open or update a PR. Use when reviewing changes before shipping, closing issues, verifying behavior, or opening a PR.
---
...
1. Gather context: diff against base branch, uncommitted changes, recent commits, changed files, and user intent.
